...
function register_elementor_widgets() {
    require_once get_stylesheet_directory().'/config/classes/elementor/PostsElementorWidget.php';
    require_once get_stylesheet_directory().'/config/classes/elementor/MembersElementorWidget.php';
