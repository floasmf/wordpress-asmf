...
<ul class="meta clr">
	...
	foreach ( $sections as $section ) { ?>
		...
		<?php if ( 'author' == $section ) { ?>
			<li class="meta-author"<?php oceanwp_schema_markup( 'author_name' ); ?>><?php echo get_the_author_posts_link(); ?></li>
		<?php } ?>
		...
		<?php if ( 'comments' == $section && comments_open() && ! post_password_required() ) { ?>
			<li class="meta-comments"><?php comments_popup_link( esc_html__( '0 Comments', 'oceanwp' ), esc_html__( '1 Comment',  'oceanwp' ), esc_html__( '% Comments', 'oceanwp' ), 'comments-link local' ); ?></li>
		<?php } ?>
